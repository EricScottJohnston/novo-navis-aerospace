    ...
    await resend.emails.send({
      ...
      html: `
        ...
        <p style="margin: 1.5rem 0;">
          <a href="https://novonavis.com/#order-form" style="background: #FFD814; color: #111; font-weight: bold; padding: 0.75rem 1.5rem; border-radius: 4px; text-decoration: none;">
