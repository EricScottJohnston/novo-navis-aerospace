    ...
    <>
      ...
      <div className="article-page">
        ...
        <div className="article-body" style={{marginTop: '2rem'}}>
          ...
          <p>Zapier is the integration backbone that connects these systems. It costs $19.99 per month for the Starter plan, $199 per month for Professional, or $99 per month for Business. For a 6 to 15 person company with 40 to 60 jobs monthly, the Professional plan at $199 monthly is typically sufficient. When a job is marked complete in Fieldproxy, Zapier automatically creates a draft invoice in QuickBooks, sends it to the customer with a payment link, and schedules automated reminders at day 7, 14, and 21 if payment has not arrived.</p>
          ...
          <p>The total investment to get started is $0 in the first week for Phase 0 measurement, followed by $99 to $199 per month for Fieldproxy once you identify scheduling as a constraint, or $199 per month for Zapier if invoicing and payment are your primary bottleneck. First measurable results appear 4 to 6 weeks after go-live on your first automation phase.</p>
